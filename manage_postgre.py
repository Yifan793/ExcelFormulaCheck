...
InitPath = './init.xlsx'
global TestCases
TestCases = "./TestCasesPostgre.xlsx"
global AllFormulaTypeTest
AllFormulaTypeTest = "./AllFormulaTypeTest_Postgre.xlsx"
global AfterAllFormulaTypeTest_Postgre
AfterAllFormulaTypeTest_Postgre = "./AfterAllFormulaTypeTest_Postgre.xlsx"
...
def after_sql_to_excel():
    ...
    # 保存修改后的Excel文件
    workbook.save(AfterAllFormulaTypeTest_Postgre)
